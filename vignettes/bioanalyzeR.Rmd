...
You could read straight through this vignette and apply all the demonstrations to your own data as you go. Or, since all the examples come from data included in the package and they are not really cumulative from one section to the next, you can just scan for output that looks useful and try the accompanying code by itself.
