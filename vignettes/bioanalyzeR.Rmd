...
We can see how the ladder peaks' median molecule lengths stay close to the expected values while the standard deviation, and to a lesser extent the skewness and kurtosis, increases from short to long molecules. (Note that the graph above shows concentration rather than molarity because the molarities of the ladder peaks are too different to graph together.)
