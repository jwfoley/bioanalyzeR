...
Install the newest release (includes 35 MB of demo data):
    ...
    > install.packages("https://github.com/jwfoley/bioanalyzeR/releases/download/v0.6.1/bioanalyzeR_0.6.1.tar.gz", repos = NULL)

or, install the newest release without the demo data:

    > install.packages("https://github.com/jwfoley/bioanalyzeR/releases/download/v0.6.1/bioanalyzeR_0.6.1-no_data.tar.gz", repos = NULL)
