...
Easy way to get the newest release (includes 30 MB of demo data):
    ...
    > install.packages("https://github.com/jwfoley/bioanalyzeR/releases/download/v0.3.1/bioanalyzeR_0.3.1.tar.gz")

Easy way without the demo data:

    > install.packages("https://github.com/jwfoley/bioanalyzeR/releases/download/v0.3.1/bioanalyzeR_0.3.1-no_data.tar.gz")
